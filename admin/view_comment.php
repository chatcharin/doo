...
<table width="100%" border="0" align="center">
  ...
  <? 
include ("../config.php");
$sql="select * from tb_comment order by id_com DESC ";
$result=mysql_query($sql);
?>
		<h4>ติดต่อข้อมูล ประกาศเพิ่มเติม </h4>
        <table width="100%" border="0">
          <tr>
            ...
            <td bordercolor="#F0F0F0" width="15%" bgcolor="#999999"><div align="center">ประกาศ</div></td>
...
$time=$rs['time'];
 	...
 	$sql2 = "select * from tb_general where id_gen='$id_gen' ";
...
?>
          <tr>
            ...
            <td valign="top"><a class="view" href="../post_view.php?id_gen=<?=$id_gen;?>"><?=$topic;?></a></td>
            ...
            <td valign="top"><div align="center">
              <input type="checkbox" name="chkDel[]" id="chkDel<?=$i;?>" value="<?=$id_com;?>">
            </div></td>
          </tr><? } ?>
        </table>
       <div align="right">
