...
$gen_id = isset($_REQUEST['gen_id']) ? $_REQUEST['gen_id'] : 8;
...
if (!$reply) {
    ...
    for ($i = 0; $i < $count; $i++) {
        ...
        $location_detail = isset($arr_reply['location_detail']) ? $arr_reply['location_detail'] : '';
        $soy = $arr_reply['location_soy'];
        $road = $arr_reply['location_road'];
        $address = $arr_reply['location_address'];
    ...
    <html>
        ...
        <body leftmargin="0" topmargin="0">
            <div id="bg" align="center" >
                <div id="image1"><img src="./img/ให้เช่า.png" width="700px" height="150px" style="left: 0px; top: 0px; float:left" /></div>
                <div id="code">CODE&nbsp;:&nbsp;
                ...
                <div id="bg2">
                    ...
                    <div id="en_detail">&nbsp;Detail&nbsp;:&nbsp;<div id="th_detail1"><?php echo $amphur . '&nbsp;' . $province ?> </div><div id="th_detail2"><?php echo $th_type . ' (' . $class_shot . ') '; ?>&nbsp;</div></div><div id="en_detail_data"><font color="#000099" size="6"><?php echo $en_class . '' . $en_topic; ?></font><br /><font color="#003399" size="5"><?php echo $en_area; ?>eng</font></div>
                ...
                <div id="logo_"><!--<img src="./img/logo1.png" width="820" height="200" />-->
                    ...
                    <div id="logo_img2">
                        <ul style="list-style-type:none; float:left;" >
                            ...
                            <li style="float:left;">
                                <font color="#003399" size="4">&nbsp;&nbsp;&nbsp;ตำบล&nbsp;:&nbsp;</font><font color="#003399" size="3">
                                <?php
                            ...
                            <br />
                            <li style="float:left;">
                                <font color="#003399" size="4">&nbsp;เขต/อำเภอ&nbsp;:&nbsp;</font><font color="#003399" size="3">
                                <?php
                                echo $amphur;
                                ?>
                                </font><br />
                            ...
                            <li style="float:left;">
                                <font color="#003399" size="4">&nbsp;&nbsp;&nbsp;จังหวัด&nbsp;:&nbsp;</font><font color="#003399" size="3">
                                <?php
                                echo $province;
                                ?>
                                </font><br />
