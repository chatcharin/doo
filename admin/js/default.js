...
$(document).ready(function(){
    ...
    $('#submitPost').click(function(){
        ...
        var postAddressen = $('#postAddressen').val();
        var postRoad = $('#postRoad').val();
        var postRoaden = $('#postRoaden').val();
        var postSoy = $('#postSoy').val();
        var postSoyen = $('#postSoyen').val();
        ...
        var locationDataen = $('#locationDataen').val();
        //3
        ...
        var detailAreaen = $('#detailAreaen').val();
        //5
        var postName = $('#postName').val();
        var postNameen = $('#postNameen').val();
            ...
            if(provinceT != 'เลือกจังหวัด' && amphurT != 'เลือกอำเภอ'){
                ...
                if(lat != '' && lng !=''){
                    ...
                    $.ajax({
                        ...
                        + "&img1=" + img1 + "&img2=" +img2+"&img3=" +img3 + "&img4=" +img4 +"&img5=" +img5 + "&topicen=" +topicen + "&locationDataen=" +locationDataen 
                        + "&detailAreaen=" +detailAreaen + "&postNameen=" +postNameen +"&postAddressen="+postAddressen +"&postRoaden=" +postRoaden +"&postSoyen=" +postSoyen ,
                        success:function(response){
                            if(response==1){
