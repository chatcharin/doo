...
$db_name = 'home-property'; //"home-property";
$conn_ = mysql_connect("localhost", "root", "") or die("Connect database false !");
mysql_select_db($db_name) or die('Select database false !');
